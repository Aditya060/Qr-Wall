"""
Django settings for qrImage project.
...
INSTALLED_APPS = [
    ...
    'whitenoise',  # Add WhiteNoise to the installed apps
]
...
ASGI_APPLICATION = "qrImage.asgi.application"
WSGI_APPLICATION = 'qrImage.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'qrImage/static'),  # This directory holds your static assets
]

# Set a STATIC_ROOT for collected files
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Directory for collected static files

# Enable compressed static file storage in production
